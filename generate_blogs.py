  ...
  <nav class="navbar" id="navbar">
    <div class="container">
      ...
      <div class="nav-links" id="navLinks">
        ...
        <a href="../contact.html" class="nav-cta">Advisory</a>
      </div>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Alfred Njeru Magara | the-infosec.com &middot; Technology &middot; Cybersecurity &middot; Resilience</p>
      </div>
    </div>
  </footer>
